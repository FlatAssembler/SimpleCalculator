   ...
   private Scriptable scope;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (ret==fc.APPROVE_OPTION){
            ...
            try {
                String tmp= new String(Files.readAllBytes(FileSystems.getDefault().getPath(ulaz.getPath())), StandardCharsets.UTF_8);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try {
            compilerCode=new String(Files.readAllBytes(FileSystems.getDefault().getPath("compiler.js")));
            controlCode=new String(Files.readAllBytes(FileSystems.getDefault().getPath("control.js")));
        }
        catch (IOException e) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int trenutniRedak=1;
        ctx.evaluateString(scope,"assembler=\"\";",null,0,null);
        ...
        jTextArea2.setText(
                (ctx.evaluateString(scope,"syntax",null,0,null)=="fasm"?";":"#")+
